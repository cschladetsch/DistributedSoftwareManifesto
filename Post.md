...
Paxos, Raft, NTP, and distributed lock; these aren't solutions to hard problems. They're compensation mechanisms for a flawed starting premise.
...
The reference implementation is KAI -- a distributed object model in C++ with reflection, persistence, cross-process communication, and an incremental tri-colour GC. Core behaviour has been stable for over 16 years.



Full writeup: https://github.com/cschladetsch/DistributedSoftwareManifesto

KAI: https://github.com/cschladetsch/KAI



#distributedsystems #cpp #gameservers #systemsdesign #architecture #gamedev
